                    ...
                    <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $linha): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                ...
                                | 
                                <a href='<?php echo e(route('categoria_ex', [ "id" => $linha->id ])); ?>' 
...
<?php echo $__env->make("admin_layout.index", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\si\Desktop\guilhermeferreira\aula\resources\views/categoria/index.blade.php ENDPATH**/ ?>